    ...
    <div className="writing-page-container">
      <article className="writing-article">
        ...
        <section className="mdp-section">
          ...
          <p>
            Silver emphasizes MDPs as the mathematical framework for RL. An MDP
            is defined by the tuple (S, A, P, R, γ):
          </p>
          ...
          <p>
            Where V<sup>π</sup>(s) is the value function under policy π, and γ
            is the discount factor balancing immediate versus future rewards.
          </p>
        </section>
        ...
        <section className="applications">
          ...
          <ul>
            ...
            <li>
              <strong>Resource Management:</strong> Optimizing data center
              cooling and energy usage
            </li>
            <li>
              <strong>Autonomous Systems:</strong> Self-driving vehicles and
              drone navigation
            </li>
          </ul>
        </section>
        ...
        <section className="challenges-future">
          ...
          <p>
            Despite its successes, Silver highlights several ongoing challenges
            in RL:
          </p>
          <ul>
